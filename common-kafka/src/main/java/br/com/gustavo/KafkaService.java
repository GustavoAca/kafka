...
public class KafkaService<T> implements Closeable {
    ...
    private KafkaService(ConsumerFunction parse, String groupId,Class<T> type, Map<String, String> properties) {
        this.parse = parse;
        this.consumer = new KafkaConsumer<>(getPropeties(groupId, type, properties));
    }
    ...
    private Properties getPropeties(String groupId, Class<T> type, Map<String, String> overrideProperties) {
